...
describe('placeOrder()', function() {
    ...
    it ('should contain the scoops objects in the payload', function() {
        const action = actions.placeOrder({ })
